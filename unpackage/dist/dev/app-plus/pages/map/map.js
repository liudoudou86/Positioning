...
(() => {
  ...
  var p = l('[{"provider":"aliyun","spaceName":"positioning","spaceId":"5260c85d-7565-4ff8-8922-3efa92885a84","clientSecret":"AguDoCV7fAJHQXo/k0FuWQ==","endpoint":"https://api.bspapp.com"}]');
  var m = "";
  try {
    m = "__UNI__BA53D3D";
  } catch (e) {
  ...
  var P = _("_globalUniCloudListener");
  var I = "response";
  var O = "clientdb";
  var b = "cloudfunction";
  var C = "cloudobject";
  ...
  var N = { request: (e) => uni.request(e), uploadFile: (e) => uni.uploadFile(e), setStorageSync: (e, t2) => uni.setStorageSync(e, t2), getStorageSync: (e) => uni.getStorageSync(e), removeStorageSync: (e) => uni.removeStorageSync(e), clearStorageSync: () => uni.clearStorageSync() };
  var M = { "uniCloud.init.paramRequired": "{param} required", "uniCloud.uploadFile.fileError": "filePath should be instance of File" };
  var { t: j } = initVueI18n({ "zh-Hans": { "uniCloud.init.paramRequired": "\u7F3A\u5C11\u53C2\u6570\uFF1A{param}", "uniCloud.uploadFile.fileError": "filePath\u5E94\u4E3AFile\u5BF9\u8C61" }, "zh-Hant": { "uniCloud.init.paramRequired": "\u7F3A\u5C11\u53C2\u6570\uFF1A{param}", "uniCloud.uploadFile.fileError": "filePath\u5E94\u4E3AFile\u5BF9\u8C61" }, en: M, fr: { "uniCloud.init.paramRequired": "{param} required", "uniCloud.uploadFile.fileError": "filePath should be instance of File" }, es: { "uniCloud.init.paramRequired": "{param} required", "uniCloud.uploadFile.fileError": "filePath should be instance of File" }, ja: M }, "zh-Hans");
  var $ = class {
    constructor(e) {
  ...
  var K = typeof location != "undefined" && location.protocol === "http:" ? "http:" : "https:";
  var H;
  !function(e) {
  ...
  var G = { adapter: null, runtime: void 0 };
  var Q = ["anonymousUuidKey"];
  ...
  var Oe = class extends Ae {
    signIn() {
      return __async(this, null, function* () {
        ...
        if (o2.uuid && o2.refresh_token) {
          this._setAnonymousUUID(o2.uuid), this.setRefreshToken(o2.refresh_token), yield this._request.refreshAccessToken(), ue(he), ue(fe, { env: this.config.env, loginType: me.ANONYMOUS, persistence: "local" });
    ...
    linkAndRetrieveDataWithTicket(e) {
      return __async(this, null, function* () {
        ...
        if (r2.refresh_token)
          return this._clearAnonymousUUID(), this.setRefreshToken(r2.refresh_token), yield this._request.refreshAccessToken(), ue(pe, { env: this.config.env }), ue(fe, { loginType: me.CUSTOM, persistence: "local" }), { credential: { refreshToken: r2.refresh_token } };
  ...
  var be = class extends Ae {
    signIn(e) {
      return __async(this, null, function* () {
        ...
        if (n2.refresh_token)
          return this.setRefreshToken(n2.refresh_token), yield this._request.refreshAccessToken(), ue(he), ue(fe, { env: this.config.env, loginType: me.CUSTOM, persistence: this.config.persistence }), yield this.refreshUserInfo(), new Ie(this.config.env);
  ...
  var Ce = class extends Ae {
    signIn(e, t2) {
      return __async(this, null, function* () {
        ...
        if (o2)
          return this.setRefreshToken(o2), r2 && i2 ? this.setAccessToken(r2, i2) : yield this._request.refreshAccessToken(), yield this.refreshUserInfo(), ue(he), ue(fe, { env: this.config.env, loginType: me.EMAIL, persistence: this.config.persistence }), new Ie(this.config.env);
  ...
  var Ee = class extends Ae {
    signIn(e, t2) {
      return __async(this, null, function* () {
        ...
        const { refreshTokenKey: n2 } = this._cache.keys, s2 = yield this._request.send("auth.signIn", { loginType: me.USERNAME, username: e, password: t2, refresh_token: this._cache.getStore(n2) || "" }), { refresh_token: o2, access_token_expire: r2, access_token: i2 } = s2;
        if (o2)
          return this.setRefreshToken(o2), i2 && r2 ? this.setAccessToken(i2, r2) : yield this._request.refreshAccessToken(), yield this.refreshUserInfo(), ue(he), ue(fe, { env: this.config.env, loginType: me.USERNAME, persistence: this.config.persistence }), new Ie(this.config.env);
  ...
  var Le = function(_0, _1) {
    return __async(this, arguments, function* ({ fileID: e }, t2) {
      const n2 = (yield qe.call(this, { fileList: [{ fileID: e, maxAge: 600 }] })).fileList[0];
      if (n2.code !== "SUCCESS")
  ...
  var Fe = function({ name: e, data: t2, query: n2, parse: s2, search: o2 }, r2) {
    const i2 = r2 || z();
    let a2;
    try {
  ...
  var Ne = { timeout: 15e3, persistence: "session" };
  var Me = {};
  var je = class {
    constructor(e) {
  ...
  var st = [{ rule: /fc_function_not_found|FUNCTION_NOT_FOUND/, content: "\uFF0C\u4E91\u51FD\u6570[{functionName}]\u5728\u4E91\u7AEF\u4E0D\u5B58\u5728\uFF0C\u8BF7\u68C0\u67E5\u6B64\u4E91\u51FD\u6570\u540D\u79F0\u662F\u5426\u6B63\u786E\u4EE5\u53CA\u8BE5\u4E91\u51FD\u6570\u662F\u5426\u5DF2\u4E0A\u4F20\u5230\u670D\u52A1\u7A7A\u95F4", mode: "append" }];
  var ot = /[\\^$.*+?()[\]{}|]/g;
  var rt = RegExp(ot.source);
  function it(e, t2, n2) {
  ...
  var ut = Symbol("CLIENT_DB_INTERNAL");
  function lt(e, t2) {
  ...
  var dt = ["db.Geo", "db.command", "command.aggregate"];
  function ft(e, t2) {
...
\u8BE6\u7EC6\u4FE1\u606F\uFF1A${s4}`), o3(r4);
  ...
  var Tt = /^(?:[A-Za-z\d+/]{4})*?(?:[A-Za-z\d+/]{2}(?:==)?|[A-Za-z\d+/]{3}=?)?$/;
  function At() {
    ...
    return function(t2, n2 = {}) {
      ...
      return new Proxy({}, { get: (n3, s3) => function n4(...c2) {
        return __async(this, null, function* () {
          ...
          try {
            u2 = yield e.callFunction({ name: t2, type: i, data: { method: s3, params: c2 } });
          } catch (e2) {
            u2 = { result: e2 };
          }
  ...
  function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    return (0, import_vue.openBlock)(), (0, import_vue.createElementBlock)("scroll-view", {
      ...
      (0, import_vue.createElementVNode)("view", { class: "content" }, [
        (0, import_vue.createElementVNode)("view", { class: "uni-list" }, [
          (0, import_vue.createElementVNode)("view", { class: "uni-list-cell" }, [
            (0, import_vue.createElementVNode)("view", { class: "uni-list-cell-db" }, [
              (0, import_vue.createElementVNode)("u-text", null, "\u540E\u53F0\u5B9A\u4F4D")
            ]),
